...
select product.pdname, product.pdsubname, factory.facname, store.stoname, store.stamount
...
SELECT PRODUCT.* 
FROM PRODUCT INNER JOIN FACTORY ON PRODUCT.FACTNO = FACTORY.FACTNO 
WHERE FACTORY.FACLOC = 'CHANGWON';
