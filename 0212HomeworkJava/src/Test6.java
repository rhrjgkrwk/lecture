...
public class Test6 {
	...
	public static void main(String[] args) {
		...
		사다리꼴의넓이 : 24.5
		*/
		System.out.printf("원의 넓이 : %.2f", area(3));
		System.out.printf("\n사각형의 넓이 : %.2f", area(4,5));
		System.out.printf("\n사다리꼴의 넓이 : %.2f", area(3,4,7));
	}
	public static double area(int a){ //원
		return  (double)Math.pow(a, 2)*PI;
	}

	public static double area(int a, int b) { //사각형
		return  (double)a*b;
	}

	public static double area(int a, int b, int c) { //사다리꼴
