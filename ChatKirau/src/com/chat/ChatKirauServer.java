...
public class ChatKirauServer {
	...
	public ChatKirauServer() {
		...
		createRoom("방1", 4569); // 임시포트 7897
		// 싱크로나이즈드 맵은 한번에 통째로 동기화시키는 것이다.
		// 클라이언트가 새로 들어올때 여기 넣고 관리.
	}

	public static void main(String[] args) {
		new ChatKirauServer().createRoom("방1", 4569); // 임시포트 7897
	}
	////////////// 서버를 열자(서버 소켓 생성)//////////////

	public void createRoom(String name, int port) { // 서버소켓을 만든다.
	...
	void sendToPerson(String msg, String nickName) { // 메세지가 넘어오면
