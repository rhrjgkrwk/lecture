...
public class ChatKirauClient extends JFrame {
	...
	private final JLabel label = new JLabel("\uB300\uD654\uCC3D");
	private final JLabel label_2 = new JLabel("\uBCF4\uB0BC \uB300\uC0C1\uC744 \uC120\uD0DD\uD574\uBCF4\uC790.");
	 ...
	 * Create the frame.
	 */
	public ChatKirauClient(Member member, String roomName, int port){
		...
		try { // 서버에 접속하고 채팅프로그램을 실행시켜보자.
			...
			System.out.println(roomName+"방에 입장 했다.");
			...
			textField.setBounds(12, 547, 370, 52);
			...
			btnNewButton.setBounds(394, 546, 72, 52);
			contentPane.add(btnNewButton);
			
			JScrollPane scrollPane = new JScrollPane();
			scrollPane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
			scrollPane.setBounds(12, 28, 310, 474);
			...
			textArea.setText(roomName+"방에 입장했다.");
			
						textArea.setEditable(false);
									
									JScrollPane scrollPane_2 = new JScrollPane();
									scrollPane_2.setBounds(331, 28, 135, 474);
									contentPane.add(scrollPane_2);
									
									scrollPane_2.setViewportView(list);
									
									JLabel label_1 = new JLabel("\uC811\uC18D\uC790");
									label_1.setForeground(Color.WHITE);
									label_1.setBounds(334, 10, 132, 15);
									contentPane.add(label_1);
												label.setForeground(Color.WHITE);
												label.setBounds(12, 10, 132, 15);
												
												contentPane.add(label);
												label_2.setForeground(Color.WHITE);
												label_2.setHorizontalAlignment(SwingConstants.CENTER);
												label_2.setBounds(12, 515, 454, 22);
